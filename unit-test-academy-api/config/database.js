...
INSERT INTO user (
    ...
    user_password,
    user_full_name
) SELECT 'evandro', 'evandro.nascimento@hivecloud.com.br', '123', 'Evandro' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'evandro')
`;
...
INSERT INTO user (
    ...
    user_password,
    user_full_name
) SELECT 'hivecloud', 'hivecloud@hivecloud.com.br', '123', 'Hivecloud' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'hivecloud')
`;
